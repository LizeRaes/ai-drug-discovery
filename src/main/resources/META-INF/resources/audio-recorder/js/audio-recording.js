...
function audioBlobToBase64(blob) {
    return new Promise((resolve, reject) => {
        ...
        reader.onloadend = () => {
            resolve(reader.result.split(',')[1]); // Extracting base64 part
        };
    ...
    stop: function () {
        ...
        return new Promise(resolve => {
            ...
            audioRecorder.mediaRecorder.addEventListener("stop", () => {
                ...
                audioBlobToBase64(audioBlob).then(base64String => {
                    console.log(base64String); // Outputs the base64 encoded audio string
                    ...
                    const options = {
                        ...
                        body: base64String // Corps de la requête contenant l'objet Blob
                    };
