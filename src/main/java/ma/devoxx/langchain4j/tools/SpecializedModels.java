...
class SpecializedModels {
    ...
    static Antibody findNewCandidateAntibody(String antigenSequence, List<Antibody> knownAntibodies) {
        Logger.getLogger(TextResource.class).info("Called findNewCandidateAntibody() with antigenSequence='" + antigenSequence + "', knownAntibodies=" + knownAntibodies);
    ...
    static String findBindingAffinity(Antibody antibody, String antigenSequence) {
        Logger.getLogger(TextResource.class).info("Called findBindingAffinity() with antibody=" + antibody + ", antigenSequence='" + antigenSequence + "'");
    ...
    static String findImmunogenicity(Antibody antibody, String antigenSequence) {
        Logger.getLogger(TextResource.class).info("Called findImmunogenicity() with antibody=" + antibody + ", antigenSequence='" + antigenSequence + "'");
    ...
    static String findToxicity(Antibody antibody, String antigenSequence) {
        Logger.getLogger(TextResource.class).info("Called findToxicity() with antibody=" + antibody + ", antigenSequence='" + antigenSequence + "'");
    ...
    static String findSpecificity(Antibody antibody, String antigenSequence) {
        Logger.getLogger(TextResource.class).info("Called findSpecificity() with antibody=" + antibody + ", antigenSequence='" + antigenSequence + "'");
    ...
    static String findStability(Antibody antibody, String antigenSequence) {
        Logger.getLogger(TextResource.class).info("Called findStability() with antibody=" + antibody + ", antigenSequence='" + antigenSequence + "'");
