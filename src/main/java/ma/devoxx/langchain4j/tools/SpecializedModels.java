...
// TODO Lize find appropriate services or make dummies
class SpecializedModels {
    ...
    static Antibody findNewCandidateAntibody(String antigenSequence, List<Antibody> knownAntibodies) {
        ...
        // TODO Lize call specialized model that proposes new candidate antibody based on antigen sequence and already analyzed antibodies with their CDRs
    ...
    static String findBindingAffinity(Antibody antibody, String antigenSequence) {
        ...
        // TODO Lize call specialized model that finds binding affinity of antibody to antigen
        // or let another LLM that is more drug specialized do a proposal
        return "0.9";
    }
    ...
    static String findImmunogenicity(Antibody antibody, String antigenSequence) {
        ...
        // TODO Lize call specialized model that finds immunogenicity of antibody to antigen
        // or let another LLM that is more drug specialized do a proposal
        return "0.1";
    }
    ...
    static String findToxicity(Antibody antibody, String antigenSequence) {
        ...
        // TODO Lize call specialized model that finds toxicity of antibody to antigen
        // or let another LLM that is more drug specialized do a proposal
        return "0.1";
    }
    ...
    static String findSpecificity(Antibody antibody, String antigenSequence) {
        ...
        // TODO Lize call specialized model that finds specificity of antibody to antigen
        // or let another LLM that is more drug specialized do a proposal
        return "0.9";
    }
    ...
    static String findStability(Antibody antibody, String antigenSequence) {
        ...
        // TODO Lize call specialized model that finds stability of antibody to antigen
        // or let another LLM that is more drug specialized do a proposal
        return "0.9";
    }
